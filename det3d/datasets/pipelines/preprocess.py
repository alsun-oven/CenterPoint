...
class AssignLabel(object):
    ...
    def __call__(self, res, info):
        ...
        if res["mode"] == "train":
            ...
            #originl res["lidar"]["annotations"]  "gt_classes" "gt_boxes"
            #current res["lidar"]["annotations"] gt_boxes_lst['current_frame', 'other_frame'] gt_names_lst['current_frame', 'other_frame'] fix:gt_dic LIST
            gt_boxes_lst = res["lidar"]["annotations"]
            ##gt_dict = res["lidar"]["annotations"]
            for gt_dic in gt_boxes_lst:
                example = {}
